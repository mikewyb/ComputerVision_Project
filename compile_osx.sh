...
#$CXX -lstdc++ -shared -Wl common.o -o libcommon.dylib 
#$CXX -lstdc++ -shared comm.o -o libcomm.dylib 
$CXX -lstdc++ -shared -I./common -I./board board.o common.o -o libboard.dylib 
...
#echo Create libplayout_multithread.
